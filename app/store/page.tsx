...
const premiumCapsule = [
  {
    brand: "PENREC Music Group",
    title: "Signature Heavyweight Tee",
    type: "Premium heavyweight tee",
    image: "/brand/penrec-primary-logo.jpg",
    copy: "Minimal black-and-gold label merchandise designed as a proper wardrobe piece, not a souvenir tee.",
    detail: "Printful / Gelato match",
  },
  {
    brand: "Fifth & Main",
    title: "Here We Are Oversized Tee",
    type: "Artist edition",
    image: "/images/artists/fifth-and-main/fifth-and-main-hero.png",
    copy: "A restrained oversized artist tee built around the Fifth & Main identity and Here We Are era.",
    detail: "Garment selection underway",
  },
  {
    brand: "The Verelles",
    title: "No Halfway Love Crewneck",
    type: "Premium crewneck",
    image: "https://audio.penrec.co.uk/verelles/hero.jpg",
    copy: "Elegant vocal-soul merchandise with a cleaner fashion-led treatment rather than a square album print.",
    detail: "Supplier matching underway",
  },
  {
    brand: "Shelley Dante",
    title: "Night Dancing Art Tee",
    type: "Limited artist edition",
    image: "/images/artists/shelley-dante/shelley-dante-hero.jpg",
    copy: "A sharper after-dark graphic direction using the Night Dancing visual world as the starting point.",
    detail: "Artwork refinement underway",
  },
  {
    brand: "PENREC Music Group",
    title: "Monogram Heavy Tote",
    type: "Label essentials",
    image: "/brand/penrec-monogram.jpg",
    copy: "Heavyweight everyday tote with a small PENREC monogram treatment and premium label-first presentation.",
    detail: "Gelato / Printful match",
  },
] as const;
  ...
  return <main id="content" className="store-page shell inside">
    ...
    <section className={styles.capsule} aria-labelledby="premium-capsule-title">
      <div className={styles.capsuleHeader}>
        <div>
          <p className="eyebrow">First capsule · preview</p>
          <h2 id="premium-capsule-title">Premium merchandise is coming to PENREC.</h2>
        </div>
      ...
      <div className={styles.capsuleGrid}>
        {premiumCapsule.map((item) => <article className={styles.card} key={item.title}>
          <div className={styles.visual}>
            ...
            <span className={styles.badge}>Capsule preview</span>
          ...
          <div className={styles.copy}>
            ...
            <h3>{item.title}</h3>
            <span>{item.copy}</span>
            <footer><b>Launching soon</b><small>{item.detail}</small></footer>
          </div>
        </article>)}
      </div>
    </section>
    ...
    <div className={styles.shopHeading}>
      <h2>Available now</h2>
      <p>Published products appear here automatically once their supplier, variant and fulfilment details are ready.</p>
    </div>
