...
export const metadata = { title: "My PENREC" };
export default async function AccountPage() {
  ...
  return <main id="content" className="account-page account-new">
    ...
    <section className="account-grid">
      ...
      {isTeam && <Link className="account-card account-card--studio" href="/admin"><span>07</span><h2>PENREC Studio</h2><p>Your account has team access.</p><b>Open Studio →</b></Link>}
    </section>
  </main>;
}
