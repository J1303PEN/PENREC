...
export default async function ProductsPage({ searchParams }: { searchParams: Promise<{created?:string;deleted?:string;error?:string}> }) {
  ...
  return <main id="content" className="studio-new">
    <header className="account-hero"><div><p className="eyebrow">PENREC Studio / Products</p><h1>Products</h1><p>Manage music formats, merchandise, pricing and fulfilment partners from one catalogue.</p></div><Link className="button" href="/admin/products/new">Create product</Link></header>
